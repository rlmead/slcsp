...
def main(plansCSV,slcspCSV,zipsCSV):
    ...
    # 3. Gather silver plan rates by state+rate_area, order them from low to high, and create a new dataframe with second-lowest-cost-per-area rates, where they exist
